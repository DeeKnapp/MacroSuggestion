...
public class LoginActivity extends BaseActivity
    ...
    @BindView(R.id.createAccountButton2)
    ...
    @Inject
    public Observer<UserObject> pendingUserObjectObserver;
    @Inject
    public Observer<PendingWaterData> pendingWaterObserver;
    ...
    void googleLoginButtonClicked(View v) {
    ...
    void createAccountClicked(View v) {
        Intent createAccountIntent = new Intent(this, OnBoardingActivityStep1.class);
        startActivity(createAccountIntent);
    }

    @OnClick(R.id.createAccountButton2)
    void createAccount2Clicked(View v) {
