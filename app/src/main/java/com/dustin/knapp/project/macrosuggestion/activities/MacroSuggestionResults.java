...
public class MacroSuggestionResults extends BaseActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.macro_suggestions);
    ...
    foodItems.add(generateMockFoodItems("Anchovies With Breadcrumbs & Scallions",
        "https://spoonacular.com/recipeImages/anchovies_with_breadcrumbs_scallions-2.jpg", "jpg",
        "38", "4g", "2g", "0g"));

    foodItems.add(generateMockFoodItems("Fish Tagine With Tomatoes, Capers, and Cinnamon",
        "https://spoonacular.com/recipeImages/fish-tagine-with-tomatoes-capers-and-cinnamon-2-111567.jpg",
        "jpg", "319", "36g", "17g", "8g"));

    foodItems.add(generateMockFoodItems("Seared Chicken with Avocado",
        "https://spoonacular.com/recipeImages/seared-chicken-with-avocado-196932.jpg", "jpg", "319",
        "36g", "17g", "8g"));

    foodItems.add(generateMockFoodItems("Lamb Shank Stew with Root Vegetables",
        "https://spoonacular.com/recipeImages/Lamb-Shank-Stew-with-Root-Vegetables-247018.jpg",
        "jpg", "319", "36g", "17g", "8g"));

    foodItems.add(generateMockFoodItems("Southwestern Chicken Salad",
        "https://spoonacular.com/recipeImages/Southwestern-Chicken-Salad-358838.jpg", "jpg", "319",
        "36g", "17g", "8g"));

    foodItems.add(
        generateMockFoodItems("Chili I", "https://spoonacular.com/recipeImages/Chili-I-362913.gif",
            "gif", "319", "36g", "17g", "8g"));

    foodItems.add(generateMockFoodItems("Cream Cake with Bing Cherry Sauce",
        "https://spoonacular.com/recipeImages/Cream-Cake-with-Bing-Cherry-Sauce-457747.png", "png",
        "319", "36g", "17g", "8g"));

    foodItems.add(generateMockFoodItems("More Power Gingerbread Smoothie",
        "https://spoonacular.com/recipeImages/More-Power-Gingerbread-Smoothie-551315.jpg", "jpg",
        "319", "36g", "17g", "8g"));

    foodItems.add(generateMockFoodItems("Slow Cooker Red Lentil Dal",
        "https://spoonacular.com/recipeImages/Slow-Cooker-Red-Lentil-Dal-573776.jpg", "jpg", "319",
        "36g", "17g", "8g"));

    foodItems.add(generateMockFoodItems("Browned Butter and Lemon Brussels Sprouts",
        "https://spoonacular.com/recipeImages/browned-butter-and-lemon-brussels-sprouts-707586.jpg",
        "jpg", "319", "36g", "17g", "8g"));
    ...
    // getFoodByMacros(macros);
  }

  public FoodItem generateMockFoodItems(String title, String imageUrl, String imageType,
  ...
  public void getFoodByMacros(ExcessMacros excessMacros) {
    ...
    apiServicesUtil.createService(FindByMacrosService.class)
        .findByMacros(excessMacros.maxCalories, excessMacros.maxCarbs, excessMacros.maxFat, excessMacros.maxProtein,
            excessMacros.minCalories, excessMacros.minCarbs, excessMacros.minFat, excessMacros.minProtein, excessMacros.number,
            excessMacros.offset, excessMacros.random)
